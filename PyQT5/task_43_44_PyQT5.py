...
class Calculator(QWidget):
    ...
    def initUI(self):
        ...
        self.r_div = QPushButton('%', self)
        self.r_div.resize(50, 50)
        self.r_div.move(60, 320)

        self.i_div = QPushButton('//', self)
        self.i_div.resize(50, 50)
        self.i_div.move(115, 320)

        self.sq = QPushButton('x²', self)
        self.sq.resize(50, 25)
        self.sq.move(170, 345)
        ...
        self.r_div.clicked.connect(self.rem_div)
        self.i_div.clicked.connect(self.int_div)
        self.sq.clicked.connect(self.squaring)
    ...
    def squaring(self):
        self.operation = 'x²'
        self.operand_1 = int(self.label.text())
        self.label.setText(f'{self.operand_1 * self.operand_1}')
    ...
    def ravno(self):
        ...
        if self.operation == '+':
            ...
            if self.operand_2 == 0:
                ...
                self.rezult = self.operand_1 % int(self.operand_2)
